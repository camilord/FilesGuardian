...
class ScanFilesCommand extends BaseCommand
{
    ...
    protected function configure()
    {
        ...
        $this
            ->addOption('mode', null, InputOption::VALUE_REQUIRED, 'Execution mode whether to lock, scan or guard the files. Mode values: lock|scan|guard')
    ...
    private function scan_files(string $dir)
    {
        ...
        foreach($files as $item) {
            ...
            } else if (in_array(substr($filename, -3), ExtConfig::get_list())) {
                if ($this->mode === Constants::EXECUTION_MODE_SCAN) {
